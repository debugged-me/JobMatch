...
<head>
  ...
  <title><?= html_escape($page_title ?? 'Register Walk-in Jobseeker') ?> - JobMatch</title>
        ...
        <div class="content-wrapper">
          <div class="row justify-content-center">
            <div class="col-lg-6">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="fw-bold mb-1">Register Walk-in Jobseeker</h4>
                  <p class="text-muted" style="font-size:.85rem">Create a jobseeker record, then continue to NSRP Form 1.</p>
                  <?= form_open('nsrp/encode') ?>
                    <div class="mb-3"><label class="form-label">Email *</label><input name="email" type="email" required class="form-control"></div>
                    <div class="row">
                      <div class="col-md-6 mb-3"><label class="form-label">First Name *</label><input name="first_name" required class="form-control"></div>
                      <div class="col-md-6 mb-3"><label class="form-label">Last Name *</label><input name="last_name" required class="form-control"></div>
                    </div>
